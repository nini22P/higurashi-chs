...
2. 将 2.0.2 版本的游戏文件放入该文件夹，包括 `data.rom`、`patch.rom` 和 `append.rom`。

3. 在终端中运行 `sh pack.sh hou`。
...
- [masagrator / HigurashiENX](https://github.com/masagrator/HigurashiENX)
